...
> [!note] **See also** — [[Class notes/HTB Academy/CWES Claude/GraphQL Attacks|GraphQL]] — first-pass endpoint audit; pairs with [[Tools/Web/graphw00f|graphw00f]] for engine fingerprinting. Also [[Class notes/HTB Academy/CWES Claude/Intro to GraphQL|Intro to GraphQL]] (CWES).
