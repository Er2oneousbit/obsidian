...
> [!note] **See also** — [[Techniques/CORS Misconfiguration|CORS Misconfiguration]], [[Techniques/CSV Injection|CSV Injection]], [[Class notes/HTB Academy/CPTS v2 (claude)/Command Injection|Command Injection]], [[Class notes/HTB Academy/CPTS v2 (claude)/Cross-Site Scripting (XSS)|Cross-Site Scripting (XSS)]], [[Techniques/Deserialization|Deserialization]], [[Class notes/HTB Academy/CPTS v2 (claude)/File Inclusion|File Inclusion]], [[Class notes/HTB Academy/CPTS v2 (claude)/File Upload Attacks|File Upload Attacks]], [[Class notes/HTB Academy/CPTS v2 (claude)/Fuzzing|Fuzzing]], [[Class notes/HTB Academy/CWES Claude/GraphQL Attacks|GraphQL]], [[Techniques/JWT Attacks|JWT Attacks]], [[Techniques/LDAP Injection|LDAP Injection]], [[Class notes/HTB Academy/CPTS v2 (claude)/Login Brute Forcing|Login Brute Forcing]], [[Techniques/NoSQL Injection|NoSQL Injection]], [[Techniques/Non-PHP Web App Attacks|Non-PHP Web App Attacks]], [[Techniques/OAuth-OIDC-SAML|OAuth-OIDC-SAML]], [[Class notes/HTB Academy/CPTS v2 (claude)/SQL Injection|SQL Injection]], [[Class notes/HTB Academy/CWES Claude/Server-Side Attacks|Server-Side Attacks]], [[Class notes/HTB Academy/CPTS v2 (claude)/Web Attacks|Web Attacks]], [[Techniques/Null Origin Attacks|Null Origin Attacks]] (CPTS v2). Also [[Class notes/HTB Academy/CWES Claude/Broken Auth|Broken Auth]] (CWES) — Intruder for OTP/token brute force, Repeater for 2FA response manipulation. Also [[Class notes/HTB Academy/CWES Claude/API Attacks|API Attacks]] (CWES) — manual API requests, JWT inspection, active scanning. Also [[Class notes/HTB Academy/CWES Claude/Intro to GraphQL|Intro to GraphQL]] (CWES) — InQL, query/mutation tampering.
