...
> [!note] **See also** — [[Class notes/HTB Academy/CPTS v2 (claude)/Fuzzing|Fuzzing]] — GraphQL fuzzing workflow; [[Class notes/HTB Academy/CPTS v2 (claude)/GraphQL|GraphQL]] — the full attack surface.
