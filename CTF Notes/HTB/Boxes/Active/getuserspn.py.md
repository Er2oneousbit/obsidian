# HTB - Active — GetUserSPNs.py

#HTB #Active #Kerberoasting #impacket #SPN

SPN enumeration as `svc_tgs`, then `-request` to capture the Administrator TGS-REP hash. Box note: [[CTF Notes/HTB/Boxes/Active/notes|notes]].
